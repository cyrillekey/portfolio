...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const formUrl = "https://formspree.io/f/xyzyjqrp";
    ...
    <div className="min-h-screen bg-background">
      <main className="pt-24 pb-20 px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            <h2 className="font-display text-2xl font-light mb-8">Contact details</h2>
            
            <div className="space-y-8">
              <div>
                <p className="text-xs tracking-[0.2em] text-muted uppercase mb-2">Email</p>
                <a 
              ...
              <div>
                <p className="text-xs tracking-[0.2em] text-muted uppercase mb-2">Phone</p>
                <a 
              ...
              <div>
                <p className="text-xs tracking-[0.2em] text-muted uppercase mb-2">Location</p>
                <p className="text-lg text-foreground/80">Nairobi, Kenya</p>
              </div>
              
              <div>
                <p className="text-xs tracking-[0.2em] text-muted uppercase mb-2">Social</p>
          ...
          <div>
            ...
            {status === "success" ? (
              <div className="p-8 border border-accent/30 bg-accent/5 rounded">
                ...
                <p className="text-foreground/60">Thanks for reaching out. I&apos;ll get back to you as soon as possible.</p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-xs tracking-[0.2em] text-muted uppercase mb-2">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-xs tracking-[0.2em] text-muted uppercase mb-2">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-xs tracking-[0.2em] text-muted uppercase mb-2">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-xs tracking-[0.2em] text-muted uppercase mb-2">
                    Message
                  </label>
                  <textarea
                    id="message"
